...
- **Constitution P8 vs. the marker-retry's visible revision** — **DECIDED 2026-08-02: buffer until final.** During any finalize retry (marker, PDF-anchor, missing-tool, learning-evidence), show only a working indicator; render the answer once, when settled. No draft text, no visible rewrite. Landed 2026-08-02.
