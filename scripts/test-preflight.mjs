...
const REQUIRED_FILES = [
	...
	"packages/browser-extension/live-voice.js",
	"packages/browser-extension/live-responses.js",
	"packages/browser-extension/live-interruptions.js",
	"packages/browser-extension/live-responses-files.js",
